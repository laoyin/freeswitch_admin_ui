 ...
 */
 ...
 function login(account, password, callbacks, loginCallback) {
     ...
     var socket = new JsSIP.WebSocketInterface('ws://192.168.188.120:5066');
     var configuration = {
         sockets: [socket],
         uri: 'sip:' + username + '@192.168.188.120:5066;transport=ws',
         password: password,
         contact_uri: 'sip:' + username + '@192.168.188.120:5066;transport=ws',
         outbound_proxy_set: 'ws://192.168.188.120:5066',
 ...
 function softPhoneCall(callee) {
     ...
     var sessondata = window.ua.call("sip:" + callee + "@1.116.82.172:9060", options);
